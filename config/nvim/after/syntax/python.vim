...
syn match pythonParam "[^,]*" contained contains=pythonExtraOperator,pythonLambdaExpr,pythonBuiltinObj,pythonBuiltinType,pythonConstant,pythonString,pythonNumber,pythonBrackets,pythonSelf,pythonComment,FCallKeyword skipwhite
...
syn match pythonClassParameters "[^,\*]*" contained contains=pythonBuiltin,pythonBuiltinObj,pythonBuiltinType,pythonExtraOperatorpythonStatement,pythonBrackets,pythonString,pythonComment,FCallKeyword skipwhite

"syn region ClassCall matchgroup=CName start='[A-Z][[:alpha:]_]\i*\s*(' end=')' contains=ClassCall,FCallKeyword,pythonString,pythonBoolean,pythonBuiltInObj
"syn region FCall matchgroup=FName start='\(\s\|^\|.\)[[:lower:]_]\i*\s*(' skip=+\(".*"\|'.*'\)+ end=')' contains=pythonExtraOperator,pythonLambdaExpr,pythonBuiltinObj,pythonBuiltinType,pythonConstant,pythonString,pythonNumber,pythonBrackets,pythonSelf,pythonComment,FCallKeyword skipwhite
...
hi def FCallKeyword ctermfg=yellow
"hi link CName Special
hi def pythonFunctionCall ctermfg=blue
